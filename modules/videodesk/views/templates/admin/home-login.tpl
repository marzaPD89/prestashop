...
<!--         <p>{l s="The videodesk module is free of charge, we don't charge any installation fee, videodesk is free to use up to 10 hours of discussion per month and per site." mod='videodesk'}</p> -->
    </div>
    <!-- > Sign Up -->
    {/if}
