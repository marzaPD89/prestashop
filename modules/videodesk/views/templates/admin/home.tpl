<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		{literal}$('span.infobulle').cluetip({splitTitle: '|'});{/literal}
	});
</script>
                    ...
                    <ul> 
                        ...
                        <li class="clearfix">
                            ...
                            <div class="progressBar" id="progressBar_{$shop.id_shop}">
                                ...
                                {if sizeof($shops_group.shops) > 1 || $shop.configuration.progressBar > 0}
                                    <script>
                                        $(document).ready(function() {
                                            $("#show_custom_{$shop.id_shop}").click(function(){
                                                $("#custom_{$shop.id_shop}").slideDown();
                                                $("#hide_custom_{$shop.id_shop}").show();
                                                $(this).hide();
                                            });
                                            $("#hide_custom_{$shop.id_shop}").click(function(){
                                                $("#custom_{$shop.id_shop}").slideUp();
                                                $("#show_custom_{$shop.id_shop}").show();
                                                $(this).hide();
                                            });
                                        });
                                    </script>
                                    <input type="submit" value="{l s='Show customization' mod='videodesk'}" name="show_custom_{$shop.id_shop}" id="show_custom_{$shop.id_shop}" class="blueButton">   
                                    <input style="display:none;" type="submit" value="{l s='Hide customization' mod='videodesk'}" name="hide_custom_{$shop.id_shop}" id="hide_custom_{$shop.id_shop}" class="blueButton">   
                                {/if} 
                            <div class="custom" id="custom_{$shop.id_shop}" style="{if sizeof($shops_group.shops) > 1 || $shop.configuration.progressBar > 0}display:none;{/if}">
                                    ...
                                    <ol>
                                        <li class="clearfix">
                                            ...
                                            <div class="right_text">
                                                ...
                                                <a {if $shop.configuration.progress_criterias == 1}style="margin-right:0px;"{/if} id="go_criterias_{$shop.id_shop}" class="blueButton" href="{$VD_BO_CONF}&id_shop={$shop.id_shop}&old_url={$shopContext}&shopConfiguration">{l s='Go' mod='videodesk'}</a>
                                            </div>
                                        </li>
                                        <li class="clearfix">
                                            <div class="left_text">
                                            ...
                                            <div class="right_text">
                                                ...
                                                <a {if $shop.configuration.progress_colors == 1}style="margin-right:0px;"{/if} id="go_colors_{$shop.id_shop}" class="blueButton" href="{$VD_BO_TEMPLATE}/{$shop.configuration.website_id}{$URL_SUFFIX}" target="_blank">{l s='Go' mod='videodesk'}</a>
                                            </div>
                                        </li>
                                        <li class="clearfix">
                                            <div class="left_text">
                                            ...
                                            <div class="right_text">
                                                ...
                                                <a {if $shop.configuration.progress_texts == 1}style="margin-right:0px;"{/if} id="go_texts_{$shop.id_shop}" class="blueButton" href="{$VD_BO_TEXTS}/{$shop.configuration.website_id}{$URL_SUFFIX}" target="_blank">{l s='Go' mod='videodesk'}</a>
                                            </div>
                                        </li>
                                        <li class="clearfix">
                                            <div class="left_text">
                                            ...
                                            <div class="right_text">
                                                ...
                                                <a {if $shop.configuration.progress_messages == 1}style="margin-right:0px;"{/if} id="go_messages_{$shop.id_shop}" class="blueButton" href="{$VD_BO_MESSAGES}/{$shop.configuration.website_id}{$URL_SUFFIX}" target="_blank">{l s='Go' mod='videodesk'}</a>
                                            </div>
                                        </li>
                                        <li class="clearfix">
                                            <div class="left_text">
                                            ...
                                            <div class="right_text">
                                                ...
                                                <a {if $shop.configuration.progress_agent == 1}style="margin-right:0px;"{/if} id="go_agent_{$shop.id_shop}" class="blueButton" href="{$VD_BO_AGENT}/{$shop.configuration.website_id}{$URL_SUFFIX}" target="_blank">{l s='Go' mod='videodesk'}</a>
                                            </div>
                                        </li>
                                    </ol>
                                </div>
