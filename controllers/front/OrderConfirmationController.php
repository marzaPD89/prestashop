...
class OrderConfirmationControllerCore extends FrontController
{
	...
	private function riloggaCustomer($customer)
    {

        $cust = new Customer($customer->id);
        //$link = new Link();
        $cust->mylogout();
      
        //Tools::redirect($link->getPageLink('authentication', true, null, ''));

        Tools::redirect($link->getPageLink('index', true, NULL, "mylogout"));
        ...
        //$context->cookie->__set('prova', 'w_prc');
        $context->cookie->id_customer = (int)$customer->id;
        //$context->cookie->name = 'PrestaShop-'.md5($customer->id.$customer->email);
